<div id="rightWrapper" class="full-page">
    ...
    <h2 class="top-logo show">Ps Yesterday</h2>
    <h3 class="logout-top"><a href="<?php echo URLROOT; ?>/users/logout">logout</a></h3>
    <div id="contentWrapper">
        <article id="showCase">
            <div class="article-header">Ps - <?php echo date('F jS Y', strtotime($data['date']));?></div>
            ...
            <div class="resrow">
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <h2>Cash Income</h2>
                        <br>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['cashps']) . ' ksh'; ?></a>
                ...
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <h2>Till Income</h2>
                        <br>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['tillps']) . ' ksh'; ?></a>
                        <div class="bottri"></div>
                    </div>
                </div>
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <h2>Total Income</h2>
                        <br>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['totalps']) . ' ksh'; ?></a>
                        <div class="bottri"></div>
                    </div>
                </div>
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <br>
                        <?php switch(true): case $data['expectedps'] >1:?>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['totalps']) . ' ksh'; ?><img
                                class="icon-img" loading="lazy"
                                src="<?php echo URLROOT; ?>/public/images/images/check.png" alt="check"></a>
                        <?php break; ?>
                        <?php case $data['expectedps']  == 0: ?>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['totalps']) . ' ksh'; ?><img
                                class="icon-img" loading="lazy"
                                src="<?php echo URLROOT; ?>/public/images/images/check.png" alt="check"></a>
                        <?php break; ?>
