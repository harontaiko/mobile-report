<div id="rightWrapper" class="full-page">
    ...
    <h2 class="top-logo show">Daily Report Yesterday</h2>
            ...
            <div class="resrow">
                ...
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <br>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['avgcashincome']).' ksh'; ?></a>
                        <div class="bottri"></div>
                    </div>
                </div>
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <br>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['avgtillincome']).' ksh'; ?></a>
                        <div class="bottri"></div>
                    </div>
                </div>
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <br>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['avgsalesincome']).' ksh'; ?></a>
                        <div class="bottri"></div>
                    </div>
                </div>
                <div class="rescol">
                    <div class="pinkbox">
                        ...
                        <br>
                        <a class="bluebutt" href="#!"><?php echo number_format($data['avggrossincome']).' ksh'; ?></a>
                        <div class="bottri"></div>
                    </div>
                </div>
            </div>
